      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var getTrackLeft = (exports.getTrackLeft = function getTrackLeft(spec) {
          ...
          var slideIndex = spec.slideIndex,
            ...
            fade = spec.fade,
            vertical = spec.vertical,
            outerEdgeLimit = spec.outerEdgeLimit;
          ...
          if (variableWidth === true) {
            ...
            } else if (outerEdgeLimit === true) {
              var lastElementWidth =
                trackElem.childNodes[trackElem.childNodes.length - 1]
                  .offsetWidth;
              var lastLeft =
                trackElem.childNodes[trackElem.childNodes.length - 1]
                  .offsetLeft * -1;
              var _outerEdgeLimit = lastLeft - lastElementWidth + slideWidth;
              targetLeft = Math.min(Math.max(targetLeft, _outerEdgeLimit), 0);
            }
          }
