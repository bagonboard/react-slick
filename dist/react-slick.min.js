          ...
          return (
            ...
            (r.ssrInit = function() {
              ...
              var f = d.default.Children.count(r.props.children),
                ...
                S =
                  -g *
                  ((0, m.getPreClones)(h) + r.state.currentSlide) *
                  y /
                  100;
        ...
        O = (t.getTrackLeft = function(e) {
          ...
          if (
            ...
            if (
              ...
              (k = o ? r + _(e) : r), (n = T && T.children[k]), (t = 0);
              for (var O = 0; O < k; O++)
                t -= T && T.children[O] && T.children[O].offsetWidth;
              (t -= parseInt(e.centerPadding)),
                (t += n && (p - n.offsetWidth) / 2);
            } else if (g === !0) {
              var x = T.childNodes[T.childNodes.length - 1].offsetWidth,
                E = T.childNodes[T.childNodes.length - 1].offsetLeft * -1,
                M = E - x + d;
              t = Math.min(Math.max(t, M), 0);
            }
          }
          return t;
        }),
